...
const Profile = () => {
  return (
    <>
        <BreadCrumbs icon={<CiSettings />} menu={"Settings"} subMenu={"Profile"} />
    ...
    <CardLayout title={"Profile"} from={"nonEdit"}>
        ...
        <div className='grid grid-cols-4 gap-10 p-10  w-9/12'>
            ...
            <div className='col-span-2'>
               <div className='flex items-center justify-start gap-6'>
                ...
                <div className='flex flex-col justify-start'>
                    <span className='text-lg font-medium text-[#006AB2]'>Pick a Profile Picture</span>
                    <span className='text-xs font-medium text-[#6C7293]'>Make sure your face is clear</span>
                </div>
            ...
            <TextField  label="Full Name" InputProps={{style: { fontSize: '16px', fontWeight:"600" },}} variant="outlined" size='small' fullWidth/>
            
            </div>

            <div className='col-span-2'>
          
            <TextField  label="CNIC #" InputProps={{style: { fontSize: '16px', fontWeight:"600" },}} variant="outlined" size='small' fullWidth/>
            ...
            <TextField  label="Email" InputProps={{style: { fontSize: '16px', fontWeight:"600" },}} type='email' variant="outlined" size='small' fullWidth/>
