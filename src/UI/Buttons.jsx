...
export const WhiteButton = ({title,icon, clickEvent ,customClass, customStyle, customFont, marginRight}) => {
  ...
  return (
    ...
    onClick={clickEvent} style={{width:customStyle, fontSize:customFont, marginRight: marginRight}} >
    {icon}
    {title}
  </Button>
  )
